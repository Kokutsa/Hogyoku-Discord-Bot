...
async def webhook(ctx, option):
  ...
  # Check if the user has the role "The Ōken"
  ...
  if option == 'rules':
    ...
    payload = {
        "embeds": [{
            ...
            "description":
            "Catch up with our community's socials:\n- 🖼️ [Instagram](https://www.instagram.com/bleachfancommunity/)\n- 💿 [TikTok](https://www.tiktok.com/@bleachdisc)\n- 🗒️ [X - The Everything App](https://x.com/BLEACHdisc) (Twitter)\n- 🎞️ [YouTube](https://www.youtube.com/@BLEACHdisc)\n- 📮 [Pinterest](https://www.pinterest.com/bleachdiscord/)\n\nShare our server with friends/family <:KonSalute:1103257592828022845>\n[beacons.ai/bleachdiscord](https://beacons.ai/bleachdiscord)",
            "color": 3223864,
            "image": {
                "url":
